...
while norm(u_bar - u_bar_prev) > epsilon
    ...
    qf = transpose(QT*(x_bar(:,num_steps)-goal_state))
    ...
    for t=num_steps:-1:1
        ...
        q = transpose(Q*(x_bar(:,t)-goal_state))
        r = transpose(R*u_bar(:,t))
    ...
    for t=1:num_steps
        u_bar(:,t) = l(:,t) + L(:,t)*(x_bar(:,t)-x_bar_prev(:,t)) % TODO: implement control update
        x_bar(:,t+1) = f(x_bar(:,t),u_bar(:,t),dt);
    end
